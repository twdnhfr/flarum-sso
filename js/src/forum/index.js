...
app.initializers.add('dbkg-sso', () => {
  ...
  LogInModal.prototype.footer = () => (
    <div>
      Ihre Zugangsdaten entsprechen Ihren Zugangsdaten für "Mein Bereich".
      <br />
      Falls Sie diese vergessen haben, können Sie{' '}
      <a style="font-weight: bold" href="https://meinbereich.dbkg.de">
        HIER
      </a>{' '}
